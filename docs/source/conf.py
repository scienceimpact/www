...
copyright = u'2014, Indiana University, Gregor von Laszewski, Fugang Wang'
...
htmlhelp_basename = 'mycloudmeshorgdoc'
...
latex_documents = [
  ('index', 'mycloudmeshorg.tex', u'mycloudmesh.org Documentation',
...
man_pages = [
    ('index', 'mycloudmeshorg', u'mycloudmesh.org Documentation',
...
texinfo_documents = [
  ('index', 'mycloudmeshorg', u'mycloudmesh.org Documentation',
   u'Gregor von Laszewski', 'mycloudmeshorg', 'One line description of project.',
   'Miscellaneous'),
]
...
#epub_basename = u'mycloudmesh.org'
